namespace Machete
{
    ...
    public static class FormatterExtensions
    {
        ...
        public static async Task<StringFormatResult<TSchema>> FormatToStringAsync<TSchema, TLayout>(this IFormatter<TSchema, TLayout> formatter, LayoutList<TLayout> input)
            where TSchema : Entity
